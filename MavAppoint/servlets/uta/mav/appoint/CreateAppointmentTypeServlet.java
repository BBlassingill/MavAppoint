...
public class CreateAppointmentTypeServlet extends HttpServlet{
	...
	protected void doGet(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		request.getRequestDispatcher("/WEB-INF/jsp/views/create_appointment_type.jsp").forward(request, response);
	}
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		LoginUser user = (LoginUser)session.getAttribute("user");
		try{
			CreateAppointmentTypeBean ca = new CreateAppointmentTypeBean();
			ca.setEmail(request.getParameter("emailAddress"));
			ca.setType(request.getParameter("type"));
			ca.setDuration(Integer.parseInt(request.getParameter("duration")));
