			...
			<div class="row col-md-16  custyle">
				<table class="table table-striped custab">
					...
					<%for (int i=0;i<array.size();i++){ 
						String date = array.get(i).getAdvisingDate();
						String time = array.get(i).getAdvisingStartTime();%>
					<tr>
						...
						<%	LocalDate localDate = LocalDate.parse(date);
							...
							if (dateTime.isBefore(currentDateTime)) {%>
								<td class="text-center"><button type="button" disabled id=button1
									<%=i%> onclick="button<%=i%>()">Cancel</button></td>
								<td class="text-center"><button type="button" disabled id=button2_
	...
	<div class="modal fade" id="emailModal" tabindex="-1">
		<div class="modal-dialog">
			<div class="modal-content">
				...
				<div class="modal-body">
					<b>Subject:</b><br>
					<input type=text name=subject id="subject"><br> <b>Message:</b><br>
